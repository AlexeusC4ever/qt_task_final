/****************************************************************************
** Meta object code from reading C++ file 'server-dlg.h'
**
...
#include <memory>
#include "../../final_final/gameserver/server-dlg.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'server-dlg.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(13, 10), // "sendPoints"
QT_MOC_LITERAL(24, 0), // ""
QT_MOC_LITERAL(25, 18), // "playerDisconnected"
QT_MOC_LITERAL(44, 16), // "on_newConnection"
QT_MOC_LITERAL(61, 12) // "on_readyRead"

    },
    "ServerDialog\0sendPoints\0\0playerDisconnected\0"
    "on_newConnection\0on_readyRead"
};
...
void *ServerDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::ServerDialog"))
        return static_cast< Ui::ServerDialog*>(this);
